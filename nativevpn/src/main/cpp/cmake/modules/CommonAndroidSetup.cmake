...
if(CMAKE_HOST_WIN32)
    set(android_env "${android_env} ${ENV_SETTER} ANDROID_NDK_ROOT=/cygdrive/c/Users/A/AppData/Local/Android/Sdk/ndk/27.0.12077973\n")
    set(android_env "${android_env} ${ENV_SETTER} PATH=D:/cygwin64/bin;${ANDROID_TOOLCHAIN_ROOT}/bin;$ENV{PATH}\n")
else ()
